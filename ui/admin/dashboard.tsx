        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="pt-4 border-t">
                    <h4 className="text-sm font-medium mb-2">Current Configuration Preview</h4>
          ...
          <TabsContent value="knowledge">
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600">Knowledge base management tools coming soon...</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="modules">
            <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600">Module configuration and management tools coming soon...</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
