      ...
      <div className="bg-white border-b p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">Cognitive AI Assistant</h1>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <div className={`w-2 h-2 rounded-full ${getStatusColor(stats.systemStatus)}`} />
                <span className="capitalize">{stats.systemStatus}</span>
                <span>•</span>
                <span>{stats.memoryEntries} user info items</span>
                <span>•</span>
                <span>{Math.round(stats.avgConfidence * 100)}% confidence</span>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-4">
        ...
        {messages.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-6">
              I'm powered by an advanced cognitive processing engine that thinks more like a human brain.
            </p>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-2 text-xs opacity-70">
                    ...
                    {message.confidence !== undefined && (
                      <span
                        className={message.role === "user" ? "text-purple-200" : getConfidenceColor(message.confidence)}
                      >
