    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "inset" ? "left-4 top-4 h-[calc(100svh-theme(spacing.8))] rounded-lg" : "",
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:border-l"
        >
          {children}
        </div>
      </div>
